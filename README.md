...
- [08/12/2026][**Qwen3.8-Max text**](https://huggingface.co/Qwen/Qwen3.8-Max) We now support full-parameter text fine-tuning for `Qwen/Qwen3.8-Max` split-FP8 checkpoints. Check out the [HellaSwag EP32/PP8 recipe](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/llm_finetune/qwen/qwen3_8_max_hellaswag_ep32_pp8.yaml) and [model coverage page](https://github.com/NVIDIA-NeMo/Automodel/blob/main/docs/model-coverage/llm/qwen/qwen3-8-max.mdx).
- [08/12/2026][**North Micro Vision**](https://huggingface.co/CohereLabs/North-Micro-Vision-instruct-preview) We now support LoRA fine-tuning for Cohere Labs' 2.4B-parameter native-resolution vision-language model. Check out the [RDR recipe](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/vlm_finetune/cohere_micro_vision/north_micro_vision_rdr.yaml) and [model coverage page](https://github.com/NVIDIA-NeMo/Automodel/blob/main/docs/model-coverage/vlm/coherelabs/north-micro-vision.mdx).
...
|  |  | [`Qwen/Qwen3.8-Max`](https://huggingface.co/Qwen/Qwen3.8-Max) | [SFT](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/llm_finetune/qwen/qwen3_8_max_hellaswag_ep32_pp8.yaml) |
...
| **VLM** | **North Micro Vision** | [`CohereLabs/North-Micro-Vision-instruct-preview`](https://huggingface.co/CohereLabs/North-Micro-Vision-instruct-preview) | [PEFT](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/vlm_finetune/cohere_micro_vision/north_micro_vision_rdr.yaml) |
