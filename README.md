...
- [08/23/2026][**Laguna XS 2.1**](https://huggingface.co/poolside/Laguna-XS-2.1) We now support full-parameter fine-tuning for Poolside's 33B-A3B Laguna XS 2.1 MoE model on a single 8-GPU node. Check out the [HellaSwag EP8 recipe](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/llm_finetune/laguna/laguna_xs_2p1_hellaswag_ep8.yaml) and [model coverage page](https://github.com/NVIDIA-NeMo/Automodel/blob/main/docs/model-coverage/llm/poolside/laguna.mdx).
