...
- [03/30/2026]**NeMo AutoModel** ships with **agent-friendly skills** in [skills/](https://github.com/NVIDIA-NeMo/Automodel/blob/main/skills/) to help you with common development tasks across the repo. We welcome PRs that improve existing skills or add new ones.
