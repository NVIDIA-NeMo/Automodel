...
- [07/21/2026][**Laguna**](https://github.com/NVIDIA-NeMo/Automodel/blob/main/docs/model-coverage/llm/poolside/laguna.mdx) We now support finetuning Poolside's Laguna MoE model family, including the MistyBasin 100B+ checkpoint. Check out our [HellaSwag EP16 recipe](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/llm_finetune/laguna/mistybasin_hellaswag_ep16.yaml).
