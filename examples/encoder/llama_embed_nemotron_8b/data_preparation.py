...
Usage:
    python examples/encoder/llama_embed_nemotron_8b/data_preparation.py --download-path path/to/dataset

Example:
    python examples/encoder/llama_embed_nemotron_8b/data_preparation.py \
