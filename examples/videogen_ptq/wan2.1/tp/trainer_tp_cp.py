...
class WanI2VLoRATrainer:
    ...
    def setup_hybrid(self):
        ...
        self.model_map, self.transformer_names = setup_func(
            ...
            local_rank=self.local_rank, lora_rank=self.lora_rank, 
            lora_alpha=self.lora_alpha, use_peft=self.use_peft_lora,
            train_transformer_2=self.train_transformer_2,
            tp_size=self.tp_size, cp_size=self.cp_size
        )
    ...
    def train(
        ...
        for epoch in range(start_epoch, num_epochs):
            ...
            if self.enable_rope_cp and rope_cp_stats:
                ...
                if total_sequences > 0:
                    ...
                    print0(f"[INFO] RoPE-CP stats: {rope_cp_stats['sequences_sharded']}/{total_sequences} "
        ...
        if is_main_process():
            ...
            with open(summary_file, "w") as f:
                f.write(f"WAN I2V LoRA Training Summary\n")
                f.write(f"================================\n")
