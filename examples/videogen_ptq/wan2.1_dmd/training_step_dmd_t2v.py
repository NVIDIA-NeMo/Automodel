...
def step_dmd_generator(
    ...
    generated_latent, gradient_mask, denoised_timestep_from, denoised_timestep_to = dmd_model._run_generator(
...
def step_dmd_critic(
    ...
    with torch.no_grad():
        generated_latent, _, denoised_timestep_from, denoised_timestep_to = dmd_model._run_generator(
            image_or_video_shape=image_or_video_shape,
            text_embeddings=text_embeddings,
