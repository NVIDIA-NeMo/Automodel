...
def parse_args():
    ...
    parser.add_argument("--debug_dir", type=str, default="./debug_videos", help="Directory containing .pt latent files")
    parser.add_argument(
        "--output_dir", type=str, default=None, help="Output directory for MP4 files (default: {debug_dir}_decoded)"
    )
    parser.add_argument(
        "--model_id", type=str, default="Wan-AI/Wan2.1-T2V-1.3B-Diffusers", help="Model ID to load VAE from"
    )
    parser.add_argument("--fps", type=int, default=16, help="Frames per second for output videos")
    parser.add_argument(
        "--filter",
        type=str,
        default=None,
