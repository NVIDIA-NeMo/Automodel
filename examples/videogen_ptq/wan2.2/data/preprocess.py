...
class VideoPreprocessor:
    ...
    def save_processed_data(
        self, video_name: str, text_embeddings: torch.Tensor, video_latents: torch.Tensor, metadata: Dict
    ):
        """
    ...
    def process_single_video(self, video_metadata: Dict):
        ...
        try:
            ...
            self.save_processed_data(video_name, text_embeddings, video_latents, video_metadata)
