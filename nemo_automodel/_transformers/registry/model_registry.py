...
MODEL_PACKAGE_SPECS: tuple[ModelPackageSpec, ...] = (
    ModelPackageSpec(
        package="nemo_automodel.components.models.mistral3",
        architectures=("Ministral3ForCausalLM",),
        model_types=("mistral", "pixtral", "mistral3"),
        optional_modules=frozenset({"tokenization"}),
        tokenizer_registrations=True,
    ),
    ModelPackageSpec(
        package="nemo_automodel.components.models.qwen3",
    ...
    ModelPackageSpec(
        package="nemo_automodel.components.models.phi4mm",
        architectures=("Phi4MMForCausalLM", "Phi4MMForConditionalGeneration"),
        model_types=("phi4mm",),
        optional_modules=frozenset({"patches"}),
        global_patches=True,
    ),
    ModelPackageSpec(
        package="nemo_automodel.components.models.qwen3_omni_moe",
        architectures=("Qwen3OmniMoeForConditionalGeneration",),
        model_types=("qwen3_omni_moe",),
        optional_modules=frozenset({"patches"}),
        pre_config_patches=True,
    ),
    ModelPackageSpec(
        package="nemo_automodel.components.models.qwen3_5_moe",
        architectures=(
    ...
    ModelPackageSpec(
        package="nemo_automodel.components.models.nemotron_flash",
        architectures=("NemotronFlashForCausalLM",),
        model_types=("nemotron_flash",),
        optional_modules=frozenset({"patches"}),
        post_shard_patches=True,
    ),
