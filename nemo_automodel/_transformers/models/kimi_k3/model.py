...
from nemo_automodel._transformers.models.common.packing import get_unpad_data, is_indexed_packed_mask
...
from nemo_automodel._transformers.models.kimi_k3.cp import (
    KimiPackedContext,
    all_gather_sequence,
        ...
        **attn_kwargs: Any,
        ...
        Args:
            ...
            kimi_packed_context: Optional document layout attached by
                :func:`~nemo_automodel._transformers.models.kimi_k3.cp.shard_batch_for_kimi_cp`;
