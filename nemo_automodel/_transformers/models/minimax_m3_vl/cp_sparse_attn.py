...
from nemo_automodel._transformers.models.gpt_oss.rope_utils import apply_rotary_emb_qk
from nemo_automodel._transformers.models.minimax_m3_vl.layers import MiniMaxM3Attention, select_sparse_blocks
