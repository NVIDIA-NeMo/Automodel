...
``nemo_automodel._transformers.models.glm_moe_dsa.kernels`` (see that package's
...
from nemo_automodel._transformers.models.glm_moe_dsa.kernels._tilelang import HAS_TILELANG
from nemo_automodel.shared.import_utils import safe_import_from

if TYPE_CHECKING:
    from nemo_automodel._transformers.models.glm_moe_dsa.kernels.cudnn_dsa import CudnnDsaPackedMetadata
...
_HAS_SLIME_INDEXER, _slime_lighting_indexer = safe_import_from(
    "nemo_automodel._transformers.models.glm_moe_dsa.kernels.indexer",
    "lighting_indexer",
...
_HAS_SLIME_SPARSE_MLA, _slime_sparse_mla = safe_import_from(
    "nemo_automodel._transformers.models.glm_moe_dsa.kernels.sparse_mla",
    "SparseMLA",
    msg="Vendored slime GLM-5.2 sparse MLA is unavailable. Install tilelang to use backend.attn='tilelang'.",
)

_CUDNN_DSA_MODULE = "nemo_automodel._transformers.models.glm_moe_dsa.kernels.cudnn_dsa"
