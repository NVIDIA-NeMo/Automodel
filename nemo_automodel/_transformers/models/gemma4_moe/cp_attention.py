...
class _Gemma4LocalKernelRingAttention(torch.autograd.Function):
    ...
    @staticmethod
    def forward(autograd_ctx, query: torch.Tensor, key: torch.Tensor, value: torch.Tensor, ring_ctx: Any):
        from nemo_automodel._transformers.models.gemma4_moe.cp_local_ring import sliding_ring_compute_fa_fwd
    ...
    @staticmethod
    def backward(autograd_ctx, grad_output: torch.Tensor):
        from nemo_automodel._transformers.models.gemma4_moe.cp_local_ring import sliding_ring_compute_fa_bwd
