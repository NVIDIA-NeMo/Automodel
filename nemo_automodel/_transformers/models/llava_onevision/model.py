...
from nemo_automodel._transformers.models.llava_onevision.rice_vit import RiceTransformer
...
class LLaVAOneVision1_5_ForConditionalGeneration(HFCheckpointingMixin, nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        from nemo_automodel._transformers.models.llava_onevision.state_dict_adapter import (
