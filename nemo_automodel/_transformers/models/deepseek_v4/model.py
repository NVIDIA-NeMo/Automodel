...
from nemo_automodel._transformers.models.deepseek_v4.state_dict_adapter import DeepSeekV4StateDictAdapter
...
class DeepseekV4ForCausalLM(HFCheckpointingMixin, nn.Module, MoEFSDPSyncMixin):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        from nemo_automodel._transformers.models.deepseek_v4.mtp import (  # noqa: PLC0415
    ...
    def _build_mtp_embed_inputs_for_pp(self, input_ids: torch.Tensor) -> tuple[torch.Tensor, ...]:
        ...
        from nemo_automodel._transformers.models.common.mtp import roll_tensor  # noqa: PLC0415
