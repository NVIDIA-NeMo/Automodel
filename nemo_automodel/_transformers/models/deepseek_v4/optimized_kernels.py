...
* Sparse attention and indexer: vendored/adapted Miles DeepSeek V4 ops in
  ``nemo_automodel._transformers.models.deepseek_v4.kernels``.  Upstream source:
  ...
  ``nemo_automodel/_transformers/models/deepseek_v4/kernels/__init__.py`` for
...
_HAS_MILES_SPARSE_ATTN, _miles_sparse_attn_tilelang = safe_import_from(
    "nemo_automodel._transformers.models.deepseek_v4.kernels.sparse_attention",
...
_HAS_MILES_INDEXER, _miles_batched_indexer_fwd = safe_import_from(
    "nemo_automodel._transformers.models.deepseek_v4.kernels.tilelang_indexer_fwd",
    "batched_indexer_fwd",
...
_HAS_MILES_INDEXER_AUTOGRAD, _miles_v4_lighting_indexer = safe_import_from(
    "nemo_automodel._transformers.models.deepseek_v4.kernels.tilelang_indexer",
    "v4_lighting_indexer",
