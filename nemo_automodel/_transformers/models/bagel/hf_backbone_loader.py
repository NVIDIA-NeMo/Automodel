...
def _load_siglip_vision_config(vit_path: str):
    ...
    from nemo_automodel._transformers.models.bagel.modeling_siglip_navit import SiglipVisionConfig
...
def initialize_bagel_non_backbone_weights(model: torch.nn.Module, *, seed: int) -> None:
    ...
    from nemo_automodel._transformers.models.bagel.embeddings import _get_2d_sincos_pos_embed
