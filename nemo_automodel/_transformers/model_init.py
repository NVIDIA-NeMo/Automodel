...
def _patched_get_init_context(cls, dtype, is_quantized, _is_ds_init_called, *args, **kwargs):
    ...
    contexts = original(cls, dtype, is_quantized, _is_ds_init_called, *args, **kwargs)
