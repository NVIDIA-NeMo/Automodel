...
class CheckpointingConfig:
    ...
    # Unsafe compatibility escape hatch for legacy .pt sidecars/checkpoints that require pickle execution.
    # Only enable for checkpoints whose provenance is trusted.
    ...
    def __post_init__(self):
        ...
        if self.allow_legacy_pickle_restore:
            logging.warning(
                "checkpoint.allow_legacy_pickle_restore=True permits pickle-based torch.load fallback. "
                "Only use it for checkpoints generated by trusted training runs."
            )
