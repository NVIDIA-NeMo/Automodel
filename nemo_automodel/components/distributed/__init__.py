...
if TYPE_CHECKING:
    ...
    from nemo_automodel.components.distributed.context_parallel.utils import (
        ...
        unshard_context_parallel_tensor,
    )
    ...
    from nemo_automodel.components.distributed.fsdp2 import FSDP2Manager, fsdp2_sharding_enabled
    ...
    from nemo_automodel.components.distributed.mesh_utils import create_ring_ulysses_mesh, get_flat_mesh, get_submesh
    from nemo_automodel.components.distributed.optimized_tp_plans import PARALLELIZE_FUNCTIONS, get_class_qualname
    ...
    from nemo_automodel.components.distributed.pipelining.hf_utils import MULTIMODAL_SUFFIXES, get_text_module
...
_LAZY_ATTRS = {
    ...
    "ReplicatedWithGradAllReduce": (".parallel_styles", "ReplicatedWithGradAllReduce"),
    ...
    "broadcast_tp_replicas": (".tp_replicas", "broadcast_tp_replicas"),
    ...
    "exclude_from_tp_replica_sync": (".tp_replicas", "exclude_from_tp_replica_sync"),
    "fsdp2_sharding_enabled": (".fsdp2", "fsdp2_sharding_enabled"),
    "fully_shard_by_dtype": (".parallelizer_utils", "fully_shard_by_dtype"),
    "get_class_qualname": (".optimized_tp_plans", "get_class_qualname"),
    ...
    "get_parallel_plan": (".parallelizer", "get_parallel_plan"),
    ...
    "resolve_strategy_config": (".config", "resolve_strategy_config"),
    ...
    "synchronize_tp_replica_gradients": (".tp_replicas", "synchronize_tp_replica_gradients"),
