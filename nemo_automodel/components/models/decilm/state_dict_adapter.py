...
"""State dict adapter for DeciLM model.

Because DeciLMAttention uses separate q_proj / k_proj / v_proj and the MLP uses
...
class DeciLMStateDictAdapter:
    """Identity (pass-through) state dict adapter for DeciLM models.
