...
class KimiVLForConditionalGeneration(HFCheckpointingMixin, PipelineModelMixin, nn.Module, MoEFSDPSyncMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        """Run the KimiVL forward, optionally as a pipeline stage.
        ...
        Args:
            ...
            image_grid_hws: Per-image patch grid of shape [num_images, 2].
        ...
        Returns:
            Logits of shape [batch, kept_sequence, vocab] when ``return_dict``
            is false, otherwise a ``LlavaCausalLMOutputWithPast`` carrying those
            logits.
        """
