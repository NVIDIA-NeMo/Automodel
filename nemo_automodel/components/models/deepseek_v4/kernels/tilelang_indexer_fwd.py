...
def tl_indexer_fwd_impl(
    ...
    return _get_tl_indexer_fwd_impl()(heads, index_dim, block_N, num_stages, threads, block_Q)
...
def clean_logits_(
    ...
    return _get_clean_logits()(threads, block_K)
