...
"""Llama-family tensor-parallel plan."""
...
def get_tp_plan(model, *, sequence_parallel: bool = False) -> dict[str, ParallelStyle]:
    """Return the Llama/Nemotron-Super tensor-parallel plan."""
    del model
    return decoder_tp_plan(paths=_TP_PATHS, sequence_parallel=sequence_parallel, fused_projections=True)
