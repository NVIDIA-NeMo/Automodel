...
"""Mistral3 VLM tensor-parallel plan."""
...
def get_tp_plan(model, *, sequence_parallel: bool = False) -> dict[str, ParallelStyle]:
    """Return the Mistral3 VLM text-decoder TP plan.

    Vision modules stay replicated and sequence parallelism is not supported by
    the multimodal wrapper.
    """
