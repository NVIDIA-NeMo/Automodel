...
class MoE(nn.Module):
    ...
    def __init__(self, config: MoEConfig, backend: BackendConfig) -> None:
        """Initialize routing, shared experts and the selected expert backend.

        Args:
            config: Expert dimensions, routing and output-combine precision.
            backend: Projection kernels and token dispatcher.
        """
        super().__init__()
