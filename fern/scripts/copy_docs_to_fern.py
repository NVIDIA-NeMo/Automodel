...
def main() -> None:
    ...
    # Copy docs/images to fern/assets/training/images if they exist
    ...
    # Copy images from docs subdirs (e.g. docs/guides/llm/*.png, docs/guides/omni/*.jpg)
    for ext in ["*.png", "*.jpg", "*.jpeg"]:
        for img_file in docs_dir.rglob(ext):
            if img_file.is_file():
                shutil.copy2(img_file, fern_training_images / img_file.name)
                print(f"Copied {img_file.relative_to(docs_dir)} to {fern_training_images}")
