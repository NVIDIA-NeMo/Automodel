...
- How-to guide: [LLM finetuning](/llm/finetune)
...
- How-to guides:
  ...
  - [Pretraining with NanoGPT](/llm/nanogpt-pretraining)
...
- How-to guide: [Knowledge distillation](/llm/knowledge-distillation)
...
- How-to guide: [Gemma 3n: Efficient multimodal fine-tuning](/omni/gemma3-3n)
