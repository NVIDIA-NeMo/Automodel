...
[![AutoModel Logo](https://raw.githubusercontent.com/NVIDIA-NeMo/Automodel/refs/heads/main/docs/automodel_diagram.png)](https://github.com/NVIDIA-NeMo/Automodel)
...
For complete benchmark results including configuration details, see the [Performance Summary](/docs/performance-summary).
