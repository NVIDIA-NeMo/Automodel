...
| Recipe | Description |
|---|---|
| [wan2_1_t2v_flow.yaml](/latest/examples/diffusion/finetune/wan2_1_t2v_flow.yaml) | Fine-tune — Wan 2.1 T2V with flow matching |
| [wan2_1_t2v_flow.yaml](/latest/examples/diffusion/pretrain/wan2_1_t2v_flow.yaml) | Pretrain — Wan 2.1 T2V with flow matching |
...
See the [Installation Guide](/latest/guides/installation) and [Diffusion Fine-Tuning Guide](/latest/guides/diffusion/finetune).

## Training

See the [Diffusion Training and Fine-Tuning Guide](/latest/guides/diffusion/finetune) and [Dataset Preparation](/latest/guides/diffusion/dataset).
