...
|---|---|---|
| [kimi2vl_cordv2.yaml](/latest/examples/vlm_finetune/kimi/kimi2vl_cordv2.yaml) | cord-v2 | SFT — Kimi-VL on CORD-v2 |
| [kimi25vl_medpix.yaml](/latest/examples/vlm_finetune/kimi/kimi25vl_medpix.yaml) | MedPix-VQA | SFT — Kimi-K25-VL on MedPix |
