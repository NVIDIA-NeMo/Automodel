...
| Recipe | Description |
|---|---|
| [gemma_2_9b_it_squad.yaml](/latest/examples/llm_finetune/gemma/gemma_2_9b_it_squad.yaml) | SFT — Gemma 2 9B IT on SQuAD |
| [gemma_2_9b_it_squad_peft.yaml](/latest/examples/llm_finetune/gemma/gemma_2_9b_it_squad_peft.yaml) | LoRA — Gemma 2 9B IT on SQuAD |
| [gemma_3_270m_squad.yaml](/latest/examples/llm_finetune/gemma/gemma_3_270m_squad.yaml) | SFT — Gemma 3 270M on SQuAD |
| [gemma_3_270m_squad_peft.yaml](/latest/examples/llm_finetune/gemma/gemma_3_270m_squad_peft.yaml) | LoRA — Gemma 3 270M on SQuAD |
...
See the [LLM Fine-Tuning Guide](/latest/guides/llm/finetune) for full SFT and LoRA instructions.
