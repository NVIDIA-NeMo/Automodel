...
| Recipe | Description |
|---|---|
| [granite_3_3_2b_instruct_squad.yaml](/latest/examples/llm_finetune/granite/granite_3_3_2b_instruct_squad.yaml) | SFT — Granite 3.3 2B Instruct on SQuAD |
| [granite_3_3_2b_instruct_squad_peft.yaml](/latest/examples/llm_finetune/granite/granite_3_3_2b_instruct_squad_peft.yaml) | LoRA — Granite 3.3 2B Instruct on SQuAD |
