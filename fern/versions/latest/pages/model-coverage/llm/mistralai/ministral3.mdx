...
| Recipe | Description |
|---|---|
| [devstral2_small_2512_squad.yaml](/latest/examples/llm_finetune/devstral/devstral2_small_2512_squad.yaml) | SFT — Devstral Small 2 24B on SQuAD |
| [devstral2_small_2512_squad_peft.yaml](/latest/examples/llm_finetune/devstral/devstral2_small_2512_squad_peft.yaml) | LoRA — Devstral Small 2 24B on SQuAD |
