...
| Recipe | Description |
|---|---|
| [baichuan_2_7b_squad.yaml](/latest/examples/llm_finetune/baichuan/baichuan_2_7b_squad.yaml) | SFT — Baichuan2 7B on SQuAD |
| [baichuan_2_7b_squad_peft.yaml](/latest/examples/llm_finetune/baichuan/baichuan_2_7b_squad_peft.yaml) | LoRA — Baichuan2 7B on SQuAD |
