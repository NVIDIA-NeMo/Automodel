...
| Recipe | Description |
|---|---|
| [cohere_command_r_7b_squad.yaml](/latest/examples/llm_finetune/cohere/cohere_command_r_7b_squad.yaml) | SFT — Command-R 7B on SQuAD |
| [cohere_command_r_7b_squad_peft.yaml](/latest/examples/llm_finetune/cohere/cohere_command_r_7b_squad_peft.yaml) | LoRA — Command-R 7B on SQuAD |
