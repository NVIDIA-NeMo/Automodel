...
| Recipe | Description |
|---|---|
| [starcoder_2_7b_squad.yaml](/latest/examples/llm_finetune/starcoder/starcoder_2_7b_squad.yaml) | SFT — StarCoder2 7B on SQuAD |
| [starcoder_2_7b_hellaswag_fp8.yaml](/latest/examples/llm_finetune/starcoder/starcoder_2_7b_hellaswag_fp8.yaml) | SFT — StarCoder2 7B on HellaSwag with FP8 |
