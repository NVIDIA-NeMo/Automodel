...
| Recipe | Description |
|---|---|
| [gpt_oss_20b.yaml](/latest/examples/llm_finetune/gpt_oss/gpt_oss_20b.yaml) | SFT — GPT-OSS 20B |
| [gpt_oss_120b.yaml](/latest/examples/llm_finetune/gpt_oss/gpt_oss_120b.yaml) | SFT — GPT-OSS 120B |
