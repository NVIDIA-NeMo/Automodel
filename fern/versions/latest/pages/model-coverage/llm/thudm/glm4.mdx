...
| Recipe | Description |
|---|---|
| [glm_4_9b_chat_hf_squad.yaml](/latest/examples/llm_finetune/glm/glm_4_9b_chat_hf_squad.yaml) | SFT — GLM-4 9B on SQuAD |
| [glm_4_9b_chat_hf_hellaswag_fp8.yaml](/latest/examples/llm_finetune/glm/glm_4_9b_chat_hf_hellaswag_fp8.yaml) | SFT — GLM-4 9B on HellaSwag with FP8 |
