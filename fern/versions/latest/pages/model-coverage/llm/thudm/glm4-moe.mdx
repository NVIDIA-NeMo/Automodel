...
| Recipe | Description |
|---|---|
| [glm_4.5_air_te_deepep.yaml](/latest/examples/llm_finetune/glm/glm_4.5_air_te_deepep.yaml) | SFT — GLM-4.5-Air with TE + DeepEP |
| [glm_4.7_te_deepep.yaml](/latest/examples/llm_finetune/glm/glm_4.7_te_deepep.yaml) | SFT — GLM-4.7 with TE + DeepEP |
| [glm_4.7_flash_te_deepep.yaml](/latest/examples/llm_finetune/glm/glm_4.7_flash_te_deepep.yaml) | SFT — GLM-4.7-Flash with TE + DeepEP |
| [glm_4.7_flash_te_packed_sequence.yaml](/latest/examples/llm_finetune/glm/glm_4.7_flash_te_packed_sequence.yaml) | SFT — GLM-4.7-Flash with packed sequences |
...
<Note>
This recipe was validated on **8 nodes × 8 GPUs (64 H100s)**. See the [Launcher Guide](/latest/launcher/slurm) for multi-node setup.
...
See the [LLM Fine-Tuning Guide](/latest/guides/llm/finetune) and the [Large MoE Fine-Tuning Guide](/latest/guides/llm/large_moe_finetune).
