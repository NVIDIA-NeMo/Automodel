...
| Recipe | Description |
|---|---|
| [qwen3_moe_30b_te_deepep.yaml](/latest/examples/llm_finetune/qwen/qwen3_moe_30b_te_deepep.yaml) | SFT — Qwen3 MoE 30B with TE + DeepEP |
| [qwen3_moe_30b_lora.yaml](/latest/examples/llm_finetune/qwen/qwen3_moe_30b_lora.yaml) | LoRA — Qwen3 MoE 30B |
