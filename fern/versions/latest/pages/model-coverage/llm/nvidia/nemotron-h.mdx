...
| Recipe | Description |
|---|---|
| [nemotron_nano_9b_squad.yaml](/latest/examples/llm_finetune/nemotron/nemotron_nano_9b_squad.yaml) | SFT — Nemotron-Nano 9B on SQuAD |
| [nemotron_nano_9b_squad_peft.yaml](/latest/examples/llm_finetune/nemotron/nemotron_nano_9b_squad_peft.yaml) | LoRA — Nemotron-Nano 9B on SQuAD |
| [nemotron_nano_v3_hellaswag.yaml](/latest/examples/llm_finetune/nemotron/nemotron_nano_v3_hellaswag.yaml) | SFT — Nemotron-3-Nano 30B on HellaSwag |
| [nemotron_nano_v3_hellaswag_peft.yaml](/latest/examples/llm_finetune/nemotron/nemotron_nano_v3_hellaswag_peft.yaml) | LoRA — Nemotron-3-Nano 30B on HellaSwag |
...
See the [LLM Fine-Tuning Guide](/latest/guides/llm/finetune).
