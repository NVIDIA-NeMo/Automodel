...
| Recipe | Description |
|---|---|
| [nemotron_flash_1b_squad.yaml](/latest/examples/llm_finetune/nemotron_flash/nemotron_flash_1b_squad.yaml) | SFT — Nemotron-Flash 1B on SQuAD |
| [nemotron_flash_1b_squad_peft.yaml](/latest/examples/llm_finetune/nemotron_flash/nemotron_flash_1b_squad_peft.yaml) | LoRA — Nemotron-Flash 1B on SQuAD |
