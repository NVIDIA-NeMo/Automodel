...
| Recipe | Description |
|---|---|
| [phi_2_squad.yaml](/latest/examples/llm_finetune/phi/phi_2_squad.yaml) | SFT — Phi-2 on SQuAD |
| [phi_2_squad_peft.yaml](/latest/examples/llm_finetune/phi/phi_2_squad_peft.yaml) | LoRA — Phi-2 on SQuAD |
