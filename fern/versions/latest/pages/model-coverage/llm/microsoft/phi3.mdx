...
| Recipe | Description |
|---|---|
| [phi_4_squad.yaml](/latest/examples/llm_finetune/phi/phi_4_squad.yaml) | SFT — Phi-4 on SQuAD |
| [phi_4_squad_peft.yaml](/latest/examples/llm_finetune/phi/phi_4_squad_peft.yaml) | LoRA — Phi-4 on SQuAD |
| [phi_3_mini_it_squad.yaml](/latest/examples/llm_finetune/phi/phi_3_mini_it_squad.yaml) | SFT — Phi-3-mini Instruct on SQuAD |
| [phi_3_mini_it_squad_peft.yaml](/latest/examples/llm_finetune/phi/phi_3_mini_it_squad_peft.yaml) | LoRA — Phi-3-mini Instruct on SQuAD |
