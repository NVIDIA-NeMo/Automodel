...
| Recipe | Description |
|---|---|
| [falcon3_7b_instruct_squad.yaml](/latest/examples/llm_finetune/falcon/falcon3_7b_instruct_squad.yaml) | SFT — Falcon3 7B Instruct on SQuAD |
| [falcon3_7b_instruct_squad_peft.yaml](/latest/examples/llm_finetune/falcon/falcon3_7b_instruct_squad_peft.yaml) | LoRA — Falcon3 7B Instruct on SQuAD |
