...
| Recipe | Description |
|---|---|
| [deepseek_v32_hellaswag_pp.yaml](/latest/examples/llm_finetune/deepseek_v32/deepseek_v32_hellaswag_pp.yaml) | SFT — DeepSeek-V3.2 on HellaSwag with pipeline parallelism |
| [moonlight_16b_te.yaml](/latest/examples/llm_finetune/moonlight/moonlight_16b_te.yaml) | SFT — Moonlight 16B with Transformer Engine |
| [moonlight_16b_te_packed_sequence.yaml](/latest/examples/llm_finetune/moonlight/moonlight_16b_te_packed_sequence.yaml) | SFT — Moonlight 16B with packed sequences |
...
<Note>
This recipe was validated on **32 nodes × 8 GPUs (256 H100s)**. See the [Launcher Guide](/latest/launcher/slurm) for multi-node setup.
