...
|---|---|---|---|
| Qwen / Alibaba Cloud | [Qwen3-Omni](/latest/model-coverage/omni/qwen/qwen3-omni) | Text · Image · Audio · Video | `Qwen3OmniForConditionalGeneration` |
| Microsoft | [Phi-4-multimodal](/latest/model-coverage/omni/microsoft/phi4-multimodal) | Text · Image · Audio | `Phi4MultimodalForCausalLM` |

## Fine-Tuning

All supported omni models can be fine-tuned using full SFT or PEFT (LoRA) approaches. See the [VLM Fine-Tuning Guide](/latest/guides/omni/gemma3-3n) for general setup instructions.
