...
|---|---|---|
| [qwen3_omni_moe_30b_te_deepep.yaml](/latest/examples/vlm_finetune/qwen3/qwen3_omni_moe_30b_te_deepep.yaml) | MedPix-VQA | SFT — Qwen3-Omni 30B with TE + DeepEP |
...
See the [Installation Guide](/latest/guides/installation) and [Omni Fine-Tuning Guide](/latest/guides/omni/gemma3-3n).

## Fine-Tuning

See the [VLM / Omni Fine-Tuning Guide](/latest/guides/omni/gemma3-3n).
