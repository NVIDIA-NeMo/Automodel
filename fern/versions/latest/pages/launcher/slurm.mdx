...
position: 3
---
In this guide, you will learn how to submit distributed training jobs on Slurm clusters (single- or multi-node). For single-node workstation usage, see [Run on Your Local Workstation](/latest/launcher/local-workstation). For setup details, refer to our [Installation Guide](/latest/guides/installation).
...
For single-node workflows, see our [Run on Your Local Workstation](/latest/launcher/local-workstation) guide.
