...
- [**Day-0 support**](/latest/model-coverage/overview) for LLMs and VLMs available on the Hugging Face Hub.
...
{/* For an in-depth explanation of the LLM recipe please also see the [LLM recipe deep-dive guide](/latest/docs/llm_recipe_deep_dive). */}
...
- **Your local workstation**: See [`docs/launcher/local-workstation.md`](/latest/launcher/local-workstation).
- **A cluster**: See [`docs/launcher/slurm.md`](/latest/launcher/slurm).
