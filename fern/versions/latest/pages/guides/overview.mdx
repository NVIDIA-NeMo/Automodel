...
- Getting started: [Installation](/latest/guides/installation)
...
- How-to guide: [LLM finetuning](/latest/guides/llm/finetune)
...
- How-to guides:
  - [LLM pretraining](/latest/guides/llm/pretraining)
  - [Pretraining with NanoGPT](/latest/guides/llm/nanogpt-pretraining)
...
- How-to guide: [Knowledge distillation](/latest/guides/llm/knowledge-distillation)
...
- How-to guide: [Gemma 3n: Efficient multimodal fine-tuning](/latest/guides/omni/gemma3-3n)
...
- How-to guide: [Diffusion fine-tuning](/latest/guides/diffusion/finetune)
...
- How-to guide: [Diffusion fine-tuning (pretraining section)](/latest/guides/diffusion/finetune#configure-your-training-recipe)
...
- How-to guide: [Diffusion generation](/latest/guides/diffusion/finetune#generation--inference)

### Dataset Preparation

Preprocessing pipeline to create `.meta` files containing VAE latents and text embeddings.

- How-to guide: [Diffusion dataset preparation](/latest/guides/diffusion/dataset)

---

If you are new to the project, begin with the [Installation](/latest/guides/installation) guide. Then, select a recipe category above and follow its linked how-to guide(s). The provided YAML configurations can serve as templates—customize them by adapting model names, datasets, and precision settings to match your specific needs.
