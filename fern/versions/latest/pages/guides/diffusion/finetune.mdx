...
|-------|-------------|------|------------|----------------|
| Wan 2.1 T2V 1.3B | `Wan-AI/Wan2.1-T2V-1.3B-Diffusers` | Text-to-Video | 1.3B | [wan2_1_t2v_flow.yaml](/latest/examples/diffusion/finetune/wan2_1_t2v_flow.yaml) |
| FLUX.1-dev | `black-forest-labs/FLUX.1-dev` | Text-to-Image | 12B | [flux_t2i_flow.yaml](/latest/examples/diffusion/finetune/flux_t2i_flow.yaml) |
| HunyuanVideo 1.5 | `hunyuanvideo-community/HunyuanVideo-1.5-Diffusers-720p_t2v` | Text-to-Video | — | [hunyuan_t2v_flow.yaml](/latest/examples/diffusion/finetune/hunyuan_t2v_flow.yaml) |
...
<Info>
**Docker users:** Checkpoints are lost when the container exits unless you bind-mount the checkpoint directory to the host. See [Install with NeMo Docker Container](/latest/guides/installation#install-with-nemo-docker-container) and [Saving Checkpoints When Using Docker](/latest/guides/checkpointing#saving-checkpoints-when-using-docker).

</Info>

For the full set of installation methods, see the [installation guide](/latest/guides/installation).
...
For the full set of arguments and input format details, see the [Diffusion Dataset Preparation](/latest/guides/diffusion/dataset) guide.
...
Below is the annotated [wan2_1_t2v_flow.yaml](/latest/examples/diffusion/finetune/wan2_1_t2v_flow.yaml), with each section explained:
...
A complete multi-node config is provided at [wan2_1_t2v_flow_multinode.yaml](/latest/examples/diffusion/finetune/wan2_1_t2v_flow_multinode.yaml).
...
- **Config**: [wan2_1_t2v_flow.yaml](/latest/examples/diffusion/finetune/wan2_1_t2v_flow.yaml)
...
- **Config**: [flux_t2i_flow.yaml](/latest/examples/diffusion/finetune/flux_t2i_flow.yaml)
...
- **Config**: [hunyuan_t2v_flow.yaml](/latest/examples/diffusion/finetune/hunyuan_t2v_flow.yaml)
...
|--------|-------|--------|------|
| [`generate_wan.yaml`](/latest/examples/diffusion/generate/configs/generate_wan.yaml) | Wan 2.1 1.3B | Video | 1 |
| [`generate_flux.yaml`](/latest/examples/diffusion/generate/configs/generate_flux.yaml) | FLUX.1-dev | Image | 1 |
| [`generate_hunyuan.yaml`](/latest/examples/diffusion/generate/configs/generate_hunyuan.yaml) | HunyuanVideo | Video | 1 |
