...
## Run PEFT (LoRA)
To apply LoRA (PEFT), uncomment the `peft` block in the config and tune rank/alpha/targets per the [SFT/PEFT guide](/latest/guides/llm/finetune). Example override:
