...
![Training Loss Curve](/latest/medpix_peft.jpg)
...
The inference functionality is provided through [`examples/vlm_generate/generate.py`](/latest/examples/vlm_generate/generate.py), which supports loading fine-tuned checkpoints and performing image-text generation.
...
![Sample image from the MedPix dataset](/latest/medpix.jpg)
