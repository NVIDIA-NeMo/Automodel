...
- See also: [LLM datasets](/latest/guides/llm/dataset), [VLM datasets](/latest/guides/vlm/dataset), and [Retrieval dataset](/latest/guides/llm/retrieval-dataset) for deeper, task-specific guides.
...
dataset:
  ...
  start_of_turn_token: "<|assistant|>"
```
See the detailed guide, [Column-Mapped Text Instruction Dataset](/latest/guides/llm/column-mapped-text-instruction-dataset), for more information.
...
```
See the [Function Calling guide](/latest/guides/llm/toolcalling) for an end-to-end example with FunctionGemma.
For a small reasoning-style chat SFT starting point, see [qwen2_5_0p5b_instruct_fineproofs_chat.yaml](/latest/examples/llm_finetune/qwen/qwen2_5_0p5b_instruct_fineproofs_chat.yaml).
...
collate_fn:
  ...
  p_max_len: 512
```
See the detailed guide, [Retrieval dataset](/latest/guides/llm/retrieval-dataset), for more information.
...
```
See the detailed [pretraining guide](/latest/guides/llm/pretraining), which uses MegatronPretraining data.
...
See [Gemma-3n](/latest/guides/omni/gemma3-3n) and [VLM dataset](/latest/guides/vlm/dataset) for end-to-end examples.
...
See the [Diffusion Dataset Preparation](/latest/guides/diffusion/dataset) guide for full preprocessing instructions and configuration details.
