...
when_to_use: Setting up a dev environment for the first time, understanding day-to-day dev workflow, debugging installation issues, running linting or tests, or onboarding a new contributor.
---
