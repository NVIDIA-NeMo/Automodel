...
| `nemo_automodel._transformers.models` | Model families trained through the Transformers bridge (LLM, VLM, MoE, and dLLM) and their state-dict adapters |
| `nemo_automodel.retrieval` | Bi-encoder and cross-encoder APIs, retrieval checkpoint/export support, and retrieval-specific model families |
