...
| **PEFT (LoRA)**             | You want to fine-tune on limited GPU memory; updates <1 % of parameters             | Instruction / chat dataset                        | LLM       | [Start LoRA](guides/llm/finetune.md#recipe-config)        |
...
| **Embedding fine-tune**     | {bdg-info}`Coming Soon`                                                             | Text pairs / retrieval corpus                     | LLM       | --                                                        |
