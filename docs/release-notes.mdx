---
title: "Release Notes"
description: "Published NeMo AutoModel release notes, with current-main context for readers using the development branch."
---
<Note>
The current `main` branch reports package version `0.5.0`. The published release notes below currently cover released versions through `0.4.0`; development-branch changes should be checked against the repository history until the next release notes are published.
</Note>
...
- **CLI install profile.** The `nemo-automodel[cli]` extra declares `pyyaml`
  and `nemo-run` for job-submission configs.
...
## 0.3.0 · 26.02 (tag created 2026-02-27; release published 2026-03-02) · [PyPI](https://pypi.org/project/nemo-automodel/0.3.0/) · [GH](https://github.com/NVIDIA-NeMo/Automodel/releases/tag/v0.3.0) · [NGC Docker](https://catalog.ngc.nvidia.com/orgs/nvidia/containers/nemo-automodel/tags?version=26.02.00)
