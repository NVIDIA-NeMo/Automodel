---
title: "MiniMax-M3"
description: "Fine-tune MiniMax-M3 text-only on Tulu-3 or with MedPix vision-language data using NeMo AutoModel supervised fine-tuning recipes."
slug: model-coverage/vision-language-models/minimax/MiniMax-M3
---
