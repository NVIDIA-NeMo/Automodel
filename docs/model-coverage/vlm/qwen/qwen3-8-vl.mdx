---
title: "Qwen3.8-27B"
description: "Fine-tune Qwen3.8-27B for vision-language tasks with NeMo AutoModel using checked-in full-parameter and LoRA recipes with distributed settings."
slug: model-coverage/vision-language-models/qwen/Qwen3.8-27B
---
