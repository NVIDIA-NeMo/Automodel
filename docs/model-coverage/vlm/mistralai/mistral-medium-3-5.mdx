...
TP=8 PP=8 DP=1. See the [Launcher Guide](../../../launcher/slurm.mdx)
...
[fine-tuning guide](../../../guides/vlm/mistral-medium-3-5.mdx) for a
...
See the [Installation Guide](../../../guides/installation.mdx) and the
[Mistral Medium 3.5 Fine-Tuning Guide](../../../guides/vlm/mistral-medium-3-5.mdx).

## Fine-Tuning

See the [Mistral Medium 3.5 Fine-Tuning Guide](../../../guides/vlm/mistral-medium-3-5.mdx).
