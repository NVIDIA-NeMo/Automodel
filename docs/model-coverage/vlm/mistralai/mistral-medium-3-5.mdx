...
description: ""
slug: model-coverage/vision-language-models/mistralai/mistral-medium-3-5
---
...
- NeMo AutoModel custom: `Mistral3FP8VLMForConditionalGeneration`
  ([source](https://github.com/NVIDIA-NeMo/Automodel/blob/main/nemo_automodel/_transformers/models/mistral3_vlm/model.py))
...
**2. Run the recipe** via Slurm (see the
