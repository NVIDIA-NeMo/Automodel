...
:::{note}
This recipe was validated on **4 nodes × 8 GPUs (32 H100s)**. See the [Launcher Guide](../../../launcher/slurm.mdx) for multi-node setup.
:::
...
See the [VLM Fine-Tuning Guide](../../../guides/omni/gemma3-3n.mdx).
