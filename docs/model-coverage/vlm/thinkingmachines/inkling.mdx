---
title: "Inkling"
description: "Fine-tune Inkling vision-language checkpoints with NeMo AutoModel using checked-in multi-node recipes with expert and pipeline parallelism."
