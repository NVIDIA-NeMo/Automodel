...
|---|---|---|---|---|
| NVIDIA | [Llama (Bidirectional)](/model-coverage/embedding-models/nvidia/llama-embed-nemotron-8b) | `LlamaBidirectionalModel` | [`NeMoAutoModelBiEncoder`](https://github.com/NVIDIA-NeMo/Automodel/blob/8dc00dcb4a35c2413c52c6e7eb7ac8f1c24836aa/nemo_automodel/_transformers/auto_model.py#L991) | Embedding, Dense Retrieval |
| NVIDIA | [Llama Nemotron VL](/model-coverage/embedding-models/nvidia/llama-embed-nemotron-8b) | `LlamaNemotronVLModel` | [`NeMoAutoModelBiEncoder`](https://github.com/NVIDIA-NeMo/Automodel/blob/8dc00dcb4a35c2413c52c6e7eb7ac8f1c24836aa/nemo_automodel/_transformers/auto_model.py#L991) | Embedding, Dense Retrieval |
| Mistral AI | [Ministral3](/model-coverage/embedding-models/mistralai/Ministral-3-3B-Base-2512) | `Ministral3Model` with `is_causal: false` | [`NeMoAutoModelBiEncoder`](https://github.com/NVIDIA-NeMo/Automodel/blob/8dc00dcb4a35c2413c52c6e7eb7ac8f1c24836aa/nemo_automodel/_transformers/auto_model.py#L991) | Embedding, Dense Retrieval |
