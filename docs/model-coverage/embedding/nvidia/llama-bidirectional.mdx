...
|---|---|---|---|
| `LlamaBidirectionalModel` | Embedding | [`NeMoAutoModelBiEncoder`](https://github.com/NVIDIA-NeMo/Automodel/blob/main/nemo_automodel/retrieval/auto_model.py) | Bidirectional Llama with mean pooling for dense embeddings |
