...
For the cross-encoder variant, see [Llama (Bidirectional) for Reranking](../../reranker/nvidia/llama-bidirectional.mdx).
...
**1. Install NeMo AutoModel**. Refer to the ([Installation Guide](../../../guides/installation.mdx)) for information:
...
See the [Installation Guide](../../../guides/installation.mdx).

{/* TODO: uncomment when finetune guide is published.
## Fine-Tuning

See the [Embedding and Reranking Fine-Tuning Guide](../../../guides/retrieval/finetune.mdx) for bi-encoder training instructions, including LoRA and PEFT configuration.
*/}
