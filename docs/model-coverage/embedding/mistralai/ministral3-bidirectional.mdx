...
|---|---|---|---|
| `Ministral3Model` with `is_causal: false` | Embedding | [`NeMoAutoModelBiEncoder`](https://github.com/NVIDIA-NeMo/Automodel/blob/main/nemo_automodel/retrieval/auto_model.py) | Preferred stock Hugging Face path for bidirectional dense embeddings |
| `Ministral3BidirectionalModel` | Embedding | [`NeMoAutoModelBiEncoder`](https://github.com/NVIDIA-NeMo/Automodel/blob/main/nemo_automodel/retrieval/auto_model.py) | Legacy compatibility path for custom retrieval checkpoints |
