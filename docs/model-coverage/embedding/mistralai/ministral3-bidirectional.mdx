---
title: "Ministral-3-3B-Base-2512"
description: "Use Ministral-3-3B-Base-2512 with NeMo AutoModel for embedding training, with documented checkpoints, a runnable starting command, setup, and model reference details."
slug: model-coverage/embedding-models/mistralai/Ministral-3-3B-Base-2512
---
...
## Train Embeddings with Ministral-3-3B-Base-2512
