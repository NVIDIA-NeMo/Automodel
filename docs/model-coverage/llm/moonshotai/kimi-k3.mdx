---
title: "Kimi-K3"
description: "Fine-tune Kimi-K3 for text generation with NeMo AutoModel using checked-in multi-node recipes with expert, pipeline, and context parallelism."
