...
**1. Install** ([NeMo AutoModel](../../../guides/installation.mdx)):
...
See the [NeMo AutoModel Installation Guide](../../../guides/installation.mdx) and [LLM Fine-Tuning Guide](../../../guides/llm/finetune.mdx).

## Fine-Tuning

See the [LLM Fine-Tuning Guide](../../../guides/llm/finetune.mdx) and the [Large MoE Fine-Tuning Guide](../../../guides/llm/large-moe-finetune.mdx).
