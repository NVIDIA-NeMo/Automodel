...
:::{note}
The full 43-layer schedule requires a multi-node run; see the recipe yaml header for `ep_size` / `pp_size` guidance. See the [Launcher Guide](../../../launcher/slurm.mdx) for multi-node setup.
:::
...
See the [Fine-Tune DeepSeek V4 Flash](../../../guides/llm/dsv4-flash.mdx) guide and the [Large MoE Fine-Tuning Guide](../../../guides/llm/large-moe-finetune.mdx).
