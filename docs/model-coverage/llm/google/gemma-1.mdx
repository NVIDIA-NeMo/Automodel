---
title: "gemma-7b"
description: "Use gemma-7b with NeMo AutoModel for text generation, with supported architecture details, canonical checkpoints, and recipe references."
slug: model-coverage/large-language-models/google/gemma-7b
---
