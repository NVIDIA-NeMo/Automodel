---
title: "gemma-2-9b-it"
description: "Use gemma-2-9b-it with NeMo AutoModel for text generation, with supported architecture details, canonical checkpoints, and recipe references."
slug: model-coverage/large-language-models/google/gemma-2-9b-it
---
