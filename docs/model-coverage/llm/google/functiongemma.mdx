...
description: "Fine-tune functiongemma-270m-it for function-calling tasks with NeMo AutoModel using the checked-in text generation recipe."
slug: model-coverage/large-language-models/google/functiongemma-270m-it
---
