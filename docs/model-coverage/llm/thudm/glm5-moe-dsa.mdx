---
title: "GLM-5"
description: "Fine-tune GLM-5 through GLM-5.3 mixture-of-experts checkpoints with NeMo AutoModel using checked-in MLA and DSA recipes."
slug: model-coverage/large-language-models/thudm/GLM-5
---
