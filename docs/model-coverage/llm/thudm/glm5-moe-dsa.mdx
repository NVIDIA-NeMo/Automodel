...
- **Optional cuDNN DSA indexer and FlashMLA sparse attention** on SM90+ GPUs through `backend.attn: cudnn`
...
| [glm_5.2_tulu3_4k_cudnn_100k.yaml](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/llm_finetune/glm/glm_5.2_tulu3_4k_cudnn_100k.yaml) | SFT — GLM-5.2 on Tulu3 with packed 4K sequences and cuDNN DSA + FlashMLA |
...
The cuDNN backend additionally requires FlashMLA's `flash_mla_sparse_fwd`, which is not
