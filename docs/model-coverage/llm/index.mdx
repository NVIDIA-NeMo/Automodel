...
| Mistral AI | [Ministral3 / Devstral](/model-coverage/large-language-models/ministral3-devstral) | `Ministral3ForCausalLM`, `Mistral3ForConditionalGeneration` |
...
| Baichuan Inc | [Baichuan / Baichuan2](/model-coverage/large-language-models/baichuan-baichuan2) | `BaichuanForCausalLM`, `BaiChuanForCausalLM` |
...
| Moonshot AI | [Kimi K3](/model-coverage/large-language-models/kimi-k3) | `KimiK3ForCausalLM` |
