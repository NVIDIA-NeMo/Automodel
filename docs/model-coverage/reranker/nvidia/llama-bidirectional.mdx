...
description: "Reference llama-nemotron-rerank-1b-v2 checkpoint and architecture details for NeMo AutoModel, with model-family information, setup guidance, and upstream resources."
