---
title: "LLaDA-8B-Base"
description: "Fine-tune LLaDA-8B-Base as a diffusion language model with NeMo AutoModel using checked-in full-parameter and LoRA recipes."
slug: model-coverage/dllm/gsai-ml/LLaDA-8B-Base
---
