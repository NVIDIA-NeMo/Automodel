...
This table lists dLLM support in reverse chronological order by the date its first recipe was added. See the [combined model support log](/model-coverage/release-log) for every model type.
