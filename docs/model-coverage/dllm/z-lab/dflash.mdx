---
title: "Qwen3-4B-DFlash-b16"
description: "Train Qwen3-4B-DFlash-b16 as a speculative-decoding draft model with NeMo AutoModel using the checked-in DFlash recipe and frozen Qwen3 target."
slug: model-coverage/dllm/z-lab/Qwen3-4B-DFlash-b16
---
