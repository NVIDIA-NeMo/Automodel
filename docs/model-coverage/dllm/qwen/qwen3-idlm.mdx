---
title: "Qwen3-8B"
description: "Convert and fine-tune Qwen3-8B as a diffusion language model with NeMo AutoModel using the checked-in I-DLM recipe and text checkpoint."
slug: model-coverage/dllm/qwen/Qwen3-8B
---
