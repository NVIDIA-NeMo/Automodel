---
title: "LLaDA2.1-mini"
description: "Fine-tune LLaDA2.1-mini as a mixture-of-experts diffusion language model with NeMo AutoModel using full-parameter and LoRA recipes."
slug: model-coverage/dllm/inclusionai/LLaDA2.1-mini
---
