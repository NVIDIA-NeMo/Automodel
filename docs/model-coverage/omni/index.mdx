...
For other installation options, see our [NeMo AutoModel Installation Guide](../../guides/installation.mdx).

## Supported Models

| Owner | Model | Modalities | Architecture |
|---|---|---|---|
| Qwen / Alibaba Cloud | [Qwen3-Omni](qwen/qwen3-omni.mdx) | Text · Image · Audio · Video | `Qwen3OmniForConditionalGeneration` |
| Microsoft | [Phi-4-multimodal](microsoft/phi4-multimodal.mdx) | Text · Image · Audio | `Phi4MultimodalForCausalLM` |
| NVIDIA | [Nemotron-3-Nano-Omni](nvidia/nemotron-omni.mdx) | Text · Image · Audio | `NemotronH_Nano_Omni_Reasoning_V3` |

## Fine-Tune Omni Models

All supported omni models can be fine-tuned using full SFT or PEFT (LoRA) approaches. See the [VLM Fine-Tuning Guide](../../guides/omni/gemma3-3n.mdx) for general setup instructions.
