...
description: "Nemotron 3.5 Super VL model coverage: architecture, Hugging Face checkpoints, and NeMo AutoModel fine-tuning recipes."
slug: model-coverage/omni/nvidia/nemotron-3-5-super-vl
---
[NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-Base-BF16](https://huggingface.co/nvidia/NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-Base-BF16)
...
The Base checkpoint is pretrained only (`sound_config` is absent).
...
|---|---|
| Base (pretrained only) | [`nvidia/NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-Base-BF16`](https://huggingface.co/nvidia/NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-Base-BF16) |
| BF16 | [`nvidia/NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-BF16`](https://huggingface.co/nvidia/NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-BF16) |

The continued-pretraining and fine-tuning recipes use the **Base (pretrained only)** checkpoint.
...
| [nemotron_3_5_super_vl_cord_v2_peft.yaml](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/vlm_finetune/nemotron_3_5_super_vl/nemotron_3_5_super_vl_cord_v2_peft.yaml) | CORD-v2 | LoRA (rank 64) on the LLM linear projections, base model frozen; receipt image to structured field tokens; single node |
