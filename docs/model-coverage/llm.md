...
| `GlmMoeDsaForCausalLM`              | GLM‑5, GLM‑5.1                        | `zai-org/GLM-5`, `zai-org/GLM-5.1` — example recipe: [glm_5_hellaswag_pp.yaml](../../examples/llm_finetune/glm/glm_5_hellaswag_pp.yaml) |
