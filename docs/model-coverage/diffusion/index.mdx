...
description: "Train diffusion models in NeMo AutoModel with flow matching, Hugging Face Diffusers, supported workflows, and dataset preparation."
position: 6
---
## Introduction
...
NeMo AutoModel supports the following workflows:
