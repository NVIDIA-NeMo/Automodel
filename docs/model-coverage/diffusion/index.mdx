...
|---|---|---|---|
| Wan AI | [Wan 2.1 T2V](wan-ai/wan2-1-t2v.mdx) | Text-to-Video | DiT (Flow Matching) |
| Black Forest Labs | [FLUX.1-dev](black-forest-labs/flux.mdx) | Text-to-Image | DiT (Flow Matching) |
| Hunyuan Community | [HunyuanVideo 1.5](hunyuanvideo-community/hunyuanvideo.mdx) | Text-to-Video | DiT (Flow Matching) |
| Qwen / Alibaba Cloud | [Qwen-Image](qwen/qwen-image.mdx) | Text-to-Image | DiT (Flow Matching) |
...
Diffusion training requires pre-encoded `.meta` files containing VAE latents and text embeddings. Raw videos or images must be preprocessed before training. See the [Diffusion Dataset Preparation](../../guides/diffusion/dataset.mdx) guide.

## Train Diffusion Models

For a complete walkthrough of training configuration, model-specific settings, and launch commands, see the [Diffusion Training and Fine-Tuning Guide](../../guides/diffusion/finetune.mdx).
