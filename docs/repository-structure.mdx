...
description: "Map the NeMo AutoModel source tree to its core components, recipes, CLI, and extension points."
position: 6
---
...
- [**Hugging Face model coverage**](/model-coverage/overview) for supported LLM and VLM families.
- **Hugging Face integration** with datasets, tokenizers, and related tools.
