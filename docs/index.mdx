...
description: "Train and fine-tune supported Hugging Face LLMs, VLMs, diffusion models, and multimodal models with NeMo AutoModel recipes, distributed PyTorch, and Hugging Face-compatible checkpoints."
---

NeMo AutoModel provides PyTorch-native recipes for training and fine-tuning supported Hugging Face models. Start with a checked-in recipe, point it at your data, then scale the same workflow from a workstation to a cluster by changing the launch command and distributed config.
...
Supported model families, runnable recipes, and known compatibility limits.
</Card>
...
# Example recipes live in the source checkout.
git clone https://github.com/NVIDIA-NeMo/Automodel.git
cd Automodel

# Llama is gated on Hugging Face. Accept the model terms, then authenticate once.
...
Expected result: the command prints the selected recipe and model, downloads `meta-llama/Llama-3.2-1B`, then logs a few training steps with `train_loss`. The short overrides keep this as a smoke test; remove them for a normal run. If authentication, CUDA packages, or example paths fail, start with [Troubleshooting Models and First Runs](/model-coverage/troubleshooting).
...
| Date | Modality | Model |
|------|----------|-------|
| 2026-06-12 | VLM | [MiniMax-M3](/model-coverage/vision-language-models/minimax-m3) ([SFT](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/vlm_finetune/minimax_m3/minimax_m3_vl_sft_ep32pp4.yaml), [LoRA](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/vlm_finetune/minimax_m3/minimax_m3_vl_lora_pp4ep8_8node.yaml)) |
| 2026-06-04 | LLM | [Nemotron-3 Ultra-550B-A55B](/recipes-e2e-examples/nemotron-3-ultra) ([recipe](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/llm_finetune/nemotron/nemotron_ultra_v3_hellaswag_peft.yaml)) |
| 2026-06-03 | LLM | [Gemma 4 12B](/model-coverage/large-language-models/gemma) ([recipe](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/llm_finetune/gemma/gemma_4_12b_hellaswag.yaml)) |
| 2026-05-27 | VLM | [Step-3.7-Flash](/recipes-e2e-examples/step-3-7) |
| 2026-05-21 | Diffusion | [Wan 2.2 T2V-A14B](/model-coverage/diffusion/wan-2-2-t2v-a14b) ([recipe](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/diffusion/finetune/wan2_2_t2v_flow.yaml)) |
| 2026-05-19 | LLM | [Ling 2.0](/model-coverage/large-language-models/ling-2-0) ([recipe](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/llm_finetune/ling/ling_mini_2_0_squad.yaml)) |
| 2026-05-18 | Audio | [Qwen3-Omni ASR](/recipes-e2e-examples/qwen3-omni-asr) ([recipe](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/audio_finetune/qwen3_omni_asr/ami_sft.yaml)) |
| 2026-05-17 | LLM | [ERNIE 4.5](/model-coverage/large-language-models/ernie-4-5) ([recipe](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/llm_finetune/ernie4_5/ernie4_5_21b_a3b_hellaswag.yaml)) |
| 2026-05-17 | LLM | [MiMo-V2-Flash](/model-coverage/large-language-models/mimo-v2-flash) ([recipe](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/llm_finetune/mimo_v2_flash/mimo_v2_flash_hellaswag.yaml)) |
...
| **Embedding fine-tune**     | You want to improve text similarity for search, retrieval, or RAG         | Text pairs / retrieval corpus                     | LLM       | [Fine-tune retrieval models](/recipes-e2e-examples/retrieval-finetune)       |
...
fp32 master weights, bf16 compute, and precision setup guidance.
