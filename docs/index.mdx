...
| Date | Modality | Model |
|------|----------|-------|
| 2026-07-30 | VLM | [Inkling / Inkling-Small](https://huggingface.co/thinkingmachines/Inkling-Small) ([Inkling_small_medpix_ep64.yaml](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/vlm_finetune/inkling/Inkling_small_medpix_ep64.yaml)) |
| 2026-07-30 | LLM | [Nemotron-3 Nano 4B](https://huggingface.co/nvidia/NVIDIA-Nemotron-3-Nano-4B-BF16) ([nemotron_nano_4b_squad_peft.yaml](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/llm_finetune/nemotron/nemotron_nano_4b_squad_peft.yaml)) |
| 2026-07-30 | Encoder-Decoder | [T5](https://huggingface.co/google-t5/t5-small) ([t5_small_squad.yaml](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/llm_finetune/t5/t5_small_squad.yaml)) |
| 2026-07-29 | LLM | [Kimi K3](https://huggingface.co/moonshotai/Kimi-K3) ([k3_hellaswag.yaml](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/llm_finetune/kimi/k3_hellaswag.yaml)) |
| 2026-07-28 | Diffusion | [LTX-2.3](https://huggingface.co/diffusers/LTX-2.3-Diffusers) ([ltx2_3_t2v_flow.yaml](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/diffusion/finetune/ltx2_3_t2v_flow.yaml)) |
| 2026-07-27 | Diffusion | [Qwen-Image-Edit-2511](https://huggingface.co/Qwen/Qwen-Image-Edit-2511) ([qwen_image_edit_2511_flow.yaml](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/diffusion/finetune/qwen_image_edit_2511_flow.yaml)) |
| 2026-07-22 | LLM | [Laguna-S-2.1](https://huggingface.co/poolside/Laguna-S-2.1) ([laguna_s_2p1_hellaswag_ep16.yaml](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/llm_finetune/laguna/laguna_s_2p1_hellaswag_ep16.yaml)) |
| 2026-06-21 | LLM | [GLM-5.2](https://huggingface.co/zai-org/GLM-5.2) ([glm_5.2_tulu3_32k_tilelang_cp8.yaml](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/llm_finetune/glm/glm_5.2_tulu3_32k_tilelang_cp8.yaml)) |
| 2026-06-10 | dLLM | [DiffusionGemma 26B-A4B](https://huggingface.co/google/diffusiongemma-26B-A4B-it) ([diffusion_gemma_sft.yaml](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/dllm_sft/diffusion_gemma_sft.yaml)) |
