...
step    0 | loss 0.5051 | grad_norm  1.96 | lr 2.00e-04 | mem 22.18 GiB
step   10 | loss 0.1096 | grad_norm  0.72 | lr 2.00e-04 | mem 22.25 GiB
step   50 | loss 0.0566 | grad_norm  0.37 | lr 2.00e-04 | mem 22.25 GiB
step  100 | loss 0.0314 | grad_norm  1.03 | lr 2.00e-04 | mem 22.25 GiB
step  200 | loss 0.0112 | grad_norm  0.16 | lr 2.00e-04 | mem 22.25 GiB
step  300 | loss 0.0144 | grad_norm  0.22 | lr 2.00e-04 | mem 22.25 GiB
step  399 | loss 0.0030 | grad_norm  0.10 | lr 2.00e-04 | mem 22.25 GiB

Validation:
  step  99 | val_loss 0.0447
  step 199 | val_loss 0.0401  <-- LOWEST_VAL
  step 299 | val_loss 0.0423
  step 399 | val_loss 0.0458
```

400 steps take ~19 min on 2x8 H100. Each checkpoint holds the adapter only (~355 MB), so
...
| LoRA PEFT, step 199 (`LOWEST_VAL`, val loss 0.040) | **9/20** | 0.952 (median 0.994; 17/20 above 0.9) | 20/20 |
| LoRA PEFT, step 399 (`LATEST`, lr=2e-4, 400 steps) | 8/20 | 0.955 (median 0.996; 15/20 above 0.9) | 20/20 |
...
| Training time | ~26 min on 8x8 H100 (~32 min wall clock) | ~19 min on 2x8 H100 |
| Best val loss | 0.061 (step 99) | 0.040 (step 199) |
| Final train loss | 0.0046 (step 399; mean of last 10 steps 0.029) | 0.0030 (step 399; mean of last 10 steps 0.011) |
| Checkpoint size | ~227 GB (consolidated bf16) | ~355 MB (adapter only) |
| Exact matches (20 val) | 8/20 at step 99 (`LOWEST_VAL`, mean similarity 0.96); 6/20 at step 399 (0.89) | 9/20 at step 199 (`LOWEST_VAL`, mean similarity 0.95); 8/20 at step 399 (0.96) |
