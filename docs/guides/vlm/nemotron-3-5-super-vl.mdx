...
Nemotron 3.5 Super VL (`nvidia/NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-Base-BF16`,
...
model:
  ...
  pretrained_model_name_or_path: nvidia/NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-Base-BF16
...
Pointing `CKPT` at the base checkpoint id (`nvidia/NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-Base-BF16`)
...
BASE = "nvidia/NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-Base-BF16"
...
|---|---|---|---|
| Base (`NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-Base-BF16`) | 0/20 | 0.048 | 0/20 (free-form description of the photo) |
