...
Nemotron 3.5 Super VL (`nvidia/NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-Base-BF16`, architecture
...
|---|---|---|---|---|
| Base (`NVIDIA-Nemotron-3.5-Super-VL-120B-A12B-Base-BF16`) | 0/20 | 0.140 | 0.141 | 0/20 |
