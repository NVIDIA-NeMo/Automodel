...
The [full SFT recipe](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/vlm_finetune/qwen3_5/qwen3_8_27b.yaml)
uses BF16, FSDP2 data parallelism, activation checkpointing, and a global batch
size of eight:

```bash
uv run automodel --nproc-per-node=8 \
  examples/vlm_finetune/qwen3_5/qwen3_8_27b.yaml
```

## Run LoRA

The [LoRA recipe](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/vlm_finetune/qwen3_5/qwen3_8_27b_lora.yaml)
...
```bash
uv run automodel --nproc-per-node=8 \
  examples/vlm_finetune/qwen3_5/qwen3_8_27b_lora.yaml
```
