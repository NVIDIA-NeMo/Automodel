...
| `enable_fsdp_float8_all_gather` | bool | False | Enable FP8 all-gather in FSDP for bandwidth savings |
| `force_recompute_fp8_weight_in_bwd` | bool | False | Force recomputation of FP8 weights in backward pass |
| `precompute_float8_dynamic_scale_for_fsdp` | bool | False | Precompute FP8 scales for FSDP optimization |
...
automodel --nproc-per-node=8 "$CONFIG_PATH"
```
...
- [FP8 Performance Benchmarks](https://pytorch.org/ao/main/workflows/training.html#performance)
