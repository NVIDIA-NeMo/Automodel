...
Below is the minimal GPT‑2 [implementation](https://github.com/NVIDIA-NeMo/Automodel/blob/main/nemo_automodel/components/models/gpt2/nanogpt.py) used for this NanoGPT‑style pretraining flow.
...
```yaml
model:
  _target_: /abs/path/to/repo/nemo_automodel/components/models/gpt2/nanogpt.py:build_gpt2_model
  vocab_size: 50258
  n_positions: 2048
  n_embd: 768
  n_layer: 12
