...
to create a bundle locally or with the source-parallel Slurm launcher. The same guide explains source selection,
per-source sample caps, append and resume workflows, and the CPU cache-warming script for the original dataset loader.
