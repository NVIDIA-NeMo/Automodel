...
- Llama-Nemotron-Embed-VL-1B multimodal (visual document retrieval) example, including a higher-throughput
  configuration and examples for adjusting batch size and activation checkpointing:
