...
For details on how to swap in your own dataset, see the [LLM Dataset Guide](https://github.com/NVIDIA-NeMo/Automodel/blob/main/docs/guides/llm/dataset.mdx) and the [Dataset Overview](https://github.com/NVIDIA-NeMo/Automodel/blob/main/docs/guides/dataset-overview.mdx).
