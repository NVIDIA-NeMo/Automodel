...
- Getting started: [Installation](installation.mdx)
...
- How-to guide: [LLM finetuning](llm/finetune.mdx)
...
- How-to guides:
  - [LLM pretraining](llm/pretraining.mdx)
  - [Pretraining with NanoGPT](llm/nanogpt-pretraining.mdx)
...
- How-to guide: [Knowledge distillation](llm/knowledge-distillation.mdx)
...
- How-to guide: [Gemma 3n: Efficient multimodal fine-tuning](omni/gemma3-3n.mdx)
...
- How-to guide: [Fine-tune Qwen3-Omni for ASR](audio/qwen3-omni-asr.mdx)
...
- How-to guide: [Diffusion fine-tuning](diffusion/finetune.mdx)
...
- How-to guide: [Diffusion fine-tuning (pretraining section)](diffusion/finetune.mdx#configure-your-training-recipe)
