...
def get_test_consolidated_llm_checkpoint_expected_keys():
    """
    Get expected checkpoint keys based on transformers version.

    Returns v4-style keys for transformers < 5.0, v5-style keys for >= 5.0.
    """
    if _is_transformers_v5():
        return _get_test_consolidated_llm_checkpoint_expected_keys_v5()
    else:
        return _get_test_consolidated_llm_checkpoint_expected_keys_v4()
...
def _get_test_consolidated_llm_checkpoint_expected_keys_v5():
    ...
    return _convert_v4_keys_to_v5(_get_test_consolidated_llm_checkpoint_expected_keys_v5())


def __get_test_consolidated_llm_checkpoint_expected_keys_v5():
    expected_model_keys = {
