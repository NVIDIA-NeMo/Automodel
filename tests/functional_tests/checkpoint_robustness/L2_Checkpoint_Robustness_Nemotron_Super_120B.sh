...
# Step 1: SFT checkpoint robustness (4 nodes, EP=32)
python -m torch.distributed.run --nproc_per_node=8 --nnodes=4 \
    ...
    --model.pretrained_model_name_or_path nvidia/NVIDIA-Nemotron-3-Super-120B-A12B-BF16 \
...
# Step 2: PEFT checkpoint robustness (1 node, EP=8)
