...
drives the WHOLE model exactly as recipes/vlm/finetune.py does under CP:
  ...
  train_ctx, batch, _ = ContextParallelSharder.shard(None, ...) # torch context_parallel shards the seq
...
def main():
    ...
    prepared_cp = ContextParallelSharder(device_mesh=device_mesh).shard(None, batch)
