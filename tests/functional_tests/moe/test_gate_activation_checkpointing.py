...
"""Functional regression for MoE gate accounting under activation checkpointing."""
...
def test_gate_load_is_accumulated_once_during_activation_checkpointing():
    ...
    apply_ac(checkpointed_model, hidden_size=8, num_experts=4)
