...
class TestTryConvertTikTokenToNative:
    ...
    def test_converts_tiktoken_tokenizer(self):
        ...
        convert_slow_tokenizer = importlib.import_module("transformers.convert_slow_tokenizer")
        tokenizers_backend = importlib.import_module("transformers.tokenization_utils_tokenizers")

        with (
            patch.object(convert_slow_tokenizer, "TikTokenConverter") as mock_converter_cls,
            patch.object(
                tokenizers_backend,
                "TokenizersBackend",
