"""
pytest suite for the ConfigNode/translate_value/_resolve_target utilities.

The tests cover
* value translation (all branches)
* dotted-path resolution, including the filesystem fall-back
* ConfigNode wrapping behaviour for scalars, lists, dicts and *_fn keys
* dotted “get”, “set_by_dotted” and membership (__contains__)
* object instantiation with and without nested sub-configs
* overrides passed to instantiate()
* to_dict() round-tripping
* __str__/__repr__ formatting sanity
* YAML loading convenience helper
* error paths (missing _target_, bad dotted path)
"""
