...
pytest tests/unit_tests/components/distributed/test_parallelizer.py -v

# Run specific test classes
pytest tests/unit_tests/components/distributed/test_parallelizer.py::TestFSDP2StrategyParallelize -v

# Run with coverage
pytest tests/unit_tests/components/distributed/test_parallelizer.py --cov=nemo_automodel.components.distributed.parallelizer
```
