...
Mirrors ``tests/unit_tests/components/models/deepseek_v4/test_deepseek_v4_mtp.py``'s
...
from tests.unit_tests.components.models.nemotron_v3.test_nemotron_v3_mtp import MockNemotronV3Config
