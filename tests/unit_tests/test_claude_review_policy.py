...
def test_review_workflow_hardens_caller_wiring():
    workflow = yaml.safe_load(WORKFLOW_PATH.read_text())
    job = _review_job()
    ...
    assert re.fullmatch(
        r"NVIDIA-NeMo/FW-CI-templates/\.github/workflows/_claude_review\.yml@7f2d495743412c5fe534102148deaee36af924f4",
        job["uses"],
    )
