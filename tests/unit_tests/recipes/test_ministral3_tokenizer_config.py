...
def test_ministral3_embedding_recipe_uses_tokenizers_backend_policy():
    ...
    assert config["tokenizer"]["tokenizer_backend"] == "tokenizers"
    assert config["tokenizer"]["fix_mistral_regex"] is True
    assert config["tokenizer"]["split_special_tokens"] is True
