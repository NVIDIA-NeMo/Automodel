...
class TestBenchmarkingRecipeRunBenchmark:
    ...
    def test_run_benchmark_exports_torch_profile_after_summary(self, mock_recipe, tmp_path):
        ...
        with patch("torch.distributed.barrier"), patch("torch.profiler.profile", return_value=profiler_context):
            mock_recipe.run_benchmark()
