...
from nemo_automodel.retrieval.models.llama_bidirectional.export_onnx import (
...
class TestExportToOnnx:
    @patch("nemo_automodel.retrieval.models.llama_bidirectional.export_onnx.torch.onnx.export")
    @patch("nemo_automodel.retrieval.models.llama_bidirectional.export_onnx.AutoModel")
    @patch("nemo_automodel.retrieval.models.llama_bidirectional.export_onnx.AutoTokenizer")
    ...
    @patch("nemo_automodel.retrieval.models.llama_bidirectional.export_onnx.verify_onnx")
    @patch("nemo_automodel.retrieval.models.llama_bidirectional.export_onnx.torch.onnx.export")
    @patch("nemo_automodel.retrieval.models.llama_bidirectional.export_onnx.AutoModel")
    @patch("nemo_automodel.retrieval.models.llama_bidirectional.export_onnx.AutoTokenizer")
...
class TestMain:
    @patch("nemo_automodel.retrieval.models.llama_bidirectional.export_onnx.export_to_onnx")
