...
"""Focused tests for Qwen4's model-specific GDN output gate."""

import torch
import torch.nn.functional as F

from nemo_automodel.components.models.qwen4_exp.layers import Qwen4ExpRMSNormGated


def test_qwen4_gdn_norm_uses_sigmoid_gate() -> None:
    norm = Qwen4ExpRMSNormGated(hidden_size=4, eps=1e-6, activation="sigmoid", dtype=torch.bfloat16)
...
def test_qwen4_gdn_norm_reset_uses_multiplicative_identity() -> None:
    norm = Qwen4ExpRMSNormGated(hidden_size=8)
